...
public class ActiveLoanInfoDTO extends LoanInfoDTO{
    ...
    public ActiveLoanInfoDTO(String loanName, String loanCategory, double sizeNoInterest, int interestPerPayment, int timePerPayment, String status, int nextTimePayment, double expectedPayment) {
