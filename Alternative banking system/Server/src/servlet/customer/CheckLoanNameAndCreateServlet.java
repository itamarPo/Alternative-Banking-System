...
@WebServlet(name = "CheckLoanNameAndCreateServlet", urlPatterns = {"/Check-Loan-Name-And-Create"})
public class CheckLoanNameAndCreateServlet extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(engine.getLoanByName((String)request.getAttribute("LoanName"))==null) {
