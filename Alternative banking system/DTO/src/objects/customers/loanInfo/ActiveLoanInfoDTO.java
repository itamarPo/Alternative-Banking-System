...
public class ActiveLoanInfoDTO extends LoanInfoDTO{
    ...
    public ActiveLoanInfoDTO(String loanName, String loanCategory, double sizeNoInterest, double interestPerPayment, int timePerPayment, String status, int nextTimePayment, double expectedPayment) {
